 ...
 * @author YIYI
 */
@WebService(serviceName = "GetFacultMessage")
public class GetFacultMessage {

    /**
     * Web service operation
     */
    @WebMethod(operationName = "getFacultMessage")
    public List getFacultMessage(@WebParam(name = "studentID") int studentID, @WebParam(name = "facultyQueueService") String facultyQueueService) {
        ...
        Message m;
          ...
          try {
                ...
                consumer = ses.createConsumer(queue, "studentID = '"+studentID+"' AND service='"+facultyQueueService+"'");
                conn.start();
