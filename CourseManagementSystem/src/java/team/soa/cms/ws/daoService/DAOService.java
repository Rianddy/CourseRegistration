...
public class DAOService {
    ...
    public team.soa.cms.serializableObj.PermissionresultSerialObj transferFromStuClassInfoToPermissionResult(@WebParam(name = "stuClassInfoMQSerialObj") StuClassInfoMQSerialObj stuClassInfoMQSerialObj) {
