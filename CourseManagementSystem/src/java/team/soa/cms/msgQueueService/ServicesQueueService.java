...
public class ServicesQueueService {
    ...
    public String setObjectBetweenService(@WebParam(name = "From") String From, @WebParam(name = "To") String To, @WebParam(name = "ClassInfo") ClassInfo classInfo, @WebParam(name = "studentInformation") StudentInformation studentInformation, @WebParam(name = "Local_ID") String Local_ID) {
        ...
        String status = producer.setObjMsg(convertStuRegCheckInfoToSerialObject(classInfo, studentInformation), propList);
