...
public class PermsReqMsgService {
    ...
    public String setPermsReq(@WebParam(name = "PermsID") String PermsID, @WebParam(name = "falEmail") String falEmail, @WebParam(name = "permsInfo") Stuclassmessage permsInfo) {
        //TODO write your implementation code here:
        StuClassInfoMQSerialObj sobj = new StuClassInfoMQSerialObj(permsInfo);
