...
public class PermsReqMsgService {
    ...
    private final String permsQueuePath = "permsFal";
    ...
    public int setPermsReq(@WebParam(name = "PermsID") String PermsID, @WebParam(name = "falEmail") String falEmail, @WebParam(name = "permsInfo") StuClassInfoMQSerialObj sobj) {
        ...
        int status = producer.setObjMsg(sobj, propList);
