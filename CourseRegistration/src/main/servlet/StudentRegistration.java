...
public class StudentRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String[] classCollection = new String[3];
            classCollection[0] = class1;
            classCollection[1] = class2;
            classCollection[2] = class3;
            StudentRegistration studentRegistration = checkStudentRegistration(studentId, classCollection);
            request.setAttribute("studentRegistration", studentRegistration); 
            request.setAttribute("classCollection", classCollection);
